...
@section('title', 'Special Training Requests | UM Attendance')

@section('content')
<div class="page-panel">
    <div class="large-box">
        <h2 class="page-title">Special Training Requests</h2>
        <p class="hero-copy">Review special training requests and approve them to mark the student as special training for the selected date range.</p>
        ...
        <div class="table-grid" style="margin-top: 24px;">
                    ...
                    <div class="form-card" style="padding: 24px; border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 18px 36px rgba(0,0,0,0.18);">
                        <div style="display: grid; grid-template-columns: minmax(240px, 1fr) auto; gap: 20px; align-items: start;">
                            ...
                            <div style="display: flex; flex-direction: column; justify-content: flex-start; gap: 12px; align-items: flex-end;">
                                <a href="/coach/special-training/{{ $request['id'] }}" class="button button-secondary" style="text-decoration:none; padding: 12px 18px; min-width: 140px;">View details</a>
                                <form method="POST" action="/coach/special-training/{{ $request['id'] }}/approve" style="margin: 0; width: 100%; display: flex; justify-content: flex-end;">
                                    @csrf
            ...
            @else
                <div class="form-card" style="margin-top: 24px;">
                    <p>No pending special training requests for your team.</p>
                </div>
            @endif
        </div>
    </div>
